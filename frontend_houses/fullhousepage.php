...
$housetype = trim($_POST['housetype']) ?? null;
$preferredfor = trim($_POST['preferredfor']) ?? null;
    ...
    <div class="filter-container">
        ...
        <div class="furnish-input-container">
            ...
            <select id="parking" name="parkingstatus">
                <option value="2wheller">2wheeler</option>
                <option value="4wheller">4wheeler</option>
            </select>
        </div>
